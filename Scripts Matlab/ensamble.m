...
qi(6,:) = [0   -0.2227    1.9794   -0.1859  0.0160    0.0160];
qi(7,:) = [0   -0.2227    1.9794   -0.1859  0.0160    0.0160];
qi(8,:) = [0   -0.2227    1.9794   -0.1859  0.0160    0.0160];
qi(9,:) = [-0.6476    1.1058    0.2157    1.8202    0.0160    0.0160];
qi(10,:) = [-0.6476    1.1833    0.7443    1.2140    0.0160    0.0160];
qi(11,:) = [-0.6476    1.1833    0.7443    1.2140         0         0];
qi(12,:) = [-0.6476    1.1057    0.2157    1.8201         0         0];
qi(13,:) = qi(1,:);
...
% Posiciones fijas
qi(1,:) = [0   -1.0000    2.4000    0.5000         0         0];
qi(6,:) = [0    0.4668    0.6160    0.4880    0.0160    0.0160];
qi(7,:) = [0    0.3498    1.0838    0.1372    0.0160    0.0160];
qi(8,:) = [0    0.3498    1.0838    0.1372   0    0];
qi(9,:) = [0   -1.0000    2.4000    0.5000         0         0];
qi(10,:) = [0   -1.0000    2.4000    0.5000         0         0];
qi(11,:) = [0   -1.0000    2.4000    0.5000         0         0];
qi(12,:) = [0   -1.0000    2.4000    0.5000         0         0];
qi(13,:) = qi(1,:);
...
for i = 1:length(qi)
    ...
    while  ~isequal( states, round(qi(i,:),2) ) || ~isequal( states2, round(qi2(i,:),2) ) 
